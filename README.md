...
<img align="right" alt="Data Monitoring" width="400" src="https://wallpaperaccess.com/full/1325192.jpg" style="background-color: transparent;" />
...
<p align="right">
   <a href="https://www.linkedin.com/in/bhumika-bharadwaj-618363215/" target="blank">     
...
<ul>
   <li><strong>Designed a Power BI Dashboard</strong> to track business KPIs (sales, profit, customer churn), integrating slicers and drill-down features for interactive storytelling.</li><br>
   <li><strong>🗃️ Wrote SQL Queries</strong> to analyze customer behavior from e-commerce data—used joins, aggregate functions, and subqueries to generate actionable insights.</li><br>
   <li><strong>Completed Google Data Analytics Professional Certificate</strong> on Coursera.</li><br>
   <li><strong>Contributed to a Non-Profit or Student Organization</strong> by volunteering hours and providing tutor training impact using Excel or Power BI. Collaborated with a team on a data dashboard project, dividing tasks like data wrangling, design, and interpretation.</li><br>
</ul>
